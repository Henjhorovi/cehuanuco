          ...
          <div class="menu_side">
            <div id="navbar_menu">
              <ul class="first-ul">
                ...
                <li> <a class="active" href="#"><b>Colegiatura</b></a>
                  <ul>
        ...
        <div class="full">
          <div class="title-holder">
            <div class="title-holder-cell text-left">
              <h1 class="page-title">Padron de Colegiados</h1>
              <ol class="breadcrumb">
                <li><a href="index.php">Inicio</a></li>
                <li class="active">Padron de Colegiados habilitados</li>
              </ol>
            </div>
          </div>
        </div>
...
<!-- section -->
<div class="section service_list">
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <div class="row">
        <div class="col-md-12">
            <div class="full">
              <div class="main_heading text_align_center">
                <h2 style="padding-top: 20px;">PADRON DE COLEGIADOS HABILITADOS</h2>
              </div>
            </div>
          </div>
          <div class="col-md-12 service_blog margin_bottom_50">
            <div class="full">
                ...
                <?PHP
                  ...
                  $stmt = $bd->prepare("SELECT * FROM colegiado WHERE estado=1"); 
                  $stmt->execute(); 
                  foreach($stmt as $colegiado)
                  {
                      echo "<tr>
                              <td>".$colegiado['nrocolegiatura']."</td>
                              <td>".$colegiado['dni']."</td>
                              <td>".$colegiado['apellidos'].", ".$colegiado['nombre']."</td>
                              <td>".$colegiado['habilitado_hasta']."</td>
