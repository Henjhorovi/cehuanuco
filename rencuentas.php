          ...
          <div class="menu_side">
            <div id="navbar_menu">
              <ul class="first-ul">
                ...
                <li> <a class="active" href="#"><b>Transparencia</b></a>
                  <ul>
                    <li><a href="rencuentas2020.php">Rendicion de Cuentas</a></li>
                  </ul>
                </li>
        ...
        <div class="full">
          <div class="title-holder">
            <div class="title-holder-cell text-left">
              <h1 class="page-title">Rendicion de Cuentas</h1>
              <ol class="breadcrumb">
...
<!-- section -->
<section class="section padding_layout_1 service_list">
    <div class="container">
        <div class="row">
          <div class="col-md-10">
            <div class="full">
                            ...
                            <div class="demo-gallery">
                                <ul id="lightgallery" class="list-unstyled row" style="text-align: center;">
                                    <?php 
                                        ...
                                        $stmt = $bd->prepare("SELECT * FROM mescuenta AS m INNER JOIN anio AS a ON m.id_anio=a.id WHERE a.anio='2021' ORDER BY m.id ASC"); 
                                        $stmt->execute(); 
                                        foreach($stmt as $mes)
                                        {
                                    ?>
                                    <li class="col-xs-6 col-sm-4 col-md-4" data-src="intranet/mescuenta/<?php echo $mes['archivo'] ?>" >
                                      <p style="font-weight:bold; font-size: 30px;"><?php echo $mes['mes'] ?></p>
                                        <a href="">
                                            <img class="img-responsive" src="intranet/mescuenta/<?php echo $mes['archivo'] ?>" width="100%">
                                        </a>
                                    </li>
                                    <?php } ?>                                    
                                </ul>
                        ...
                        <div class="col-lg-2 col-md-2 col-sm-12 col-xs-12 pull-left">
                          <div class="side_bar">
                            <div class="side_bar_blog">
                              ...
                              <div class="categary">
                                <ul>
                                  <li><a href="rencuentas.php"><i class="fa fa-caret-right"></i> 2021</a></li>
                                  <li><a href="rencuentas2020.php"><i class="fa fa-caret-right"></i> 2020</a></li>
                                  <li><a href="rencuentas2019.php"><i class="fa fa-caret-right"></i> 2019</a></li>
                                  <li><a href="rencuentas2018.php"><i class="fa fa-caret-right"></i> 2018</a></li>
                                  <li><a href="rencuentas2017.php"><i class="fa fa-caret-right"></i> 2017</a></li>
                                  <li><a href="rencuentas2016.php"><i class="fa fa-caret-right"></i> 2016</a></li>
                                </ul>
                              </div>
                            </div>
                          </div>
