          ...
          <div class="full">
            <div class="topbar-left">
              <ul class="list-inline">
                <li> <span class="topbar-label"><i class="fa  fa-home"></i></span> <span class="topbar-hightlight">Jr Huallayco Nº 1141 2do piso</span> </li>
                <li> <span class="topbar-label"><i class="fa fa-envelope-o"></i></span> <span class="topbar-hightlight"><a href="mailto:colegioeconomistash@hotmail.com">colegioeconomistash@hotmail.com</a></span> </li>
              </ul>
            </div>
          </div>
        </div>
        <div class="col-md-4 right_section_header_top">
          <div class="float-left">
            <div class="social_icon">
              <ul class="list-inline">
                <li><a class="fa fa-facebook" href="https://www.facebook.com/cehuanuco.org.pe" title="Facebook" target="_blank"></a></li>
          ...
          <div class="float-right">
            <div class="make_appo"> <a class="btn white_btn" target="_blank" href="http://cehuanuco.org.pe/intranet/login.php"><b>Sistema WEB</b></a> </div>
          </div>
        </div>
      </div>
    </div>
      ...
      <div class="row">
        ...
        <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
          ...
          <div class="menu_side">
            <div id="navbar_menu">
              <ul class="first-ul">
                <li> <a class="active" href="index.php"><b>Inicio</b></a>
                  <!-- <ul>
                    <li><a href="it_home.html">It Home Page</a></li>
                    <li><a href="it_home_dark.html">It Dark Home Page</a></li>
                  </ul> -->
                </li>
                <li><a href="#"><b>Institucion</b></a>
                  <ul>
                    <li><a href="nosotros.html">Nosotros</a></li>
                    <li><a href="historia.html">Historia</a></li>
                    <li><a href="consejodirectivo.html">Concejo Directivo</a></li>
                    <li><a target="_blank" href="archivos/LEY DEL ECONOMISTA.pdf">Ley del Economista</a></li>
                    <li><a target="_blank" href="archivos/ESTATUTO VIGENTE  2017 - 2018.pdf">Estatuto</a></li>
                    <li><a target="_blank" href="archivos/Ordenanza Regional de Hco 035-2012 Colegiados.pdf">Ordenanza</a></li>
                  </ul>
                </li>
                <li> <a href="#"><b>Colegiatura</b></a>
                  <ul>
                    <li><a href="requisitos.html">Requisitos</a></li>
                    <li><a href="colegiados.php">Padron de Colegiados</a></li>
                    <li><a href="colhabilitados.php">Colegiados Habilitados</a></li>
                    <li><a href="colnohabilitados.php">Colegiados no Habilitados</a></li>
                  </ul>
                </li>
                <li> <a href="#"><b>Eventos</b></a>
                  <ul>
                  <li> <a href="#"><b>Publicaciones</b></a>
                    <li><a href="desfile.html">Desfile</a></li>
                    <li><a href="juramentacion2017.html">Juramentacion</a></li>
                    <li><a href="fiesta2018.html">Fiesta</a></li>
                    <li><a href="campeonato.html">Evento Deportivo</a></li>
                  </ul>
                </li>
                <!-- <li> <a href="#">Pages</a>
                  <ul>
                ...
                <li> <a href="#"><b>Transparencia</b></a>
                  <ul>
                    <li><a href="rencuentas.php">Rendicion de Cuentas</a></li>
                  </ul>
                </li>
                <li> <a href="contacto.html"><b>Contacto</b></a></li>
                <li> <a href="#"><b>Elecciones</b></a>
                   <ul>
                    <li><a href="#">Comite Electoral</a></li>
                    <li><a href="#">Lista de Partidos</a></li>
                    <li><a href="#">Reglamentacion</a></li>
                    <li><a target="_blank" href="http://cehuanuco.org.pe/intranet/eleccioneslogin.php"><b>VOTO</b></a></li>
                  </ul> 
                </li>
              </ul>
            </div>
    ...
    <div class="row">
      <div id="rev_slider_4_1_wrapper" class="rev_slider_wrapper fullwidthbanner-container" data-alias="classicslider1" style="margin:0px auto;background-color:transparent;padding:0px;margin-top:0px;margin-bottom:0px;">
        ...
        <div id="rev_slider_4_1" class="rev_slider fullwidthabanner" style="display:none;" data-version="5.0.7">
          <ul>
            <li data-index="rs-1812" data-transition="zoomin" data-slotamount="7"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000"  data-thumb="images/it_service/slide11.jpeg"  data-rotate="0"  data-saveperformance="off"  data-title="slide1" data-description="">
              <!-- MAIN IMAGE -->
              <img src="images/it_service/slide11.jpeg"  alt="#"  data-bgposition="center center" data-kenburns="on" data-duration="30000" data-ease="Linear.easeNone" data-scalestart="100" data-scaleend="120" data-rotatestart="0" data-rotateend="0" data-offsetstart="0 0" data-offsetend="0 0" data-bgparallax="10" class="rev-slidebg" data-no-retina>
              <!-- LAYERS -->
              <!-- LAYER NR. BG -->
              ...
              <div class="tp-caption NotGeneric-Title   tp-resizeme rs-parallaxlevel-0" 
                              ...
                              style="z-index: 6; white-space: nowrap;">Colegio de Economistas de Huánuco </div>
              <!-- LAYER NR. 3 -->
              <div class="tp-caption NotGeneric-SubTitle   tp-resizeme rs-parallaxlevel-0" 
                              ...
                              data-splitout="none" 
                              data-responsive_offset="on" 
                              style="z-index: 7; white-space: nowrap;">TAVANTIN SVIO QVIPOC </div>
            </li>
            <!-- <li data-index="rs-181" data-transition="zoomin" data-slotamount="7"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000"  data-thumb="images/it_service/slide10.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="slide2" data-description="">
              <img src="images/it_service/slide10.jpg"  alt=""  data-bgposition="center center" data-kenburns="on" data-duration="30000" data-ease="Linear.easeNone" data-scalestart="100" data-scaleend="120" data-rotatestart="0" data-rotateend="0" data-offsetstart="0 0" data-offsetend="0 0" data-bgparallax="10" class="rev-slidebg" data-no-retina>
              <div class="tp-caption tp-shape tp-shapewrapper   rs-parallaxlevel-0" 
            ...
            <li data-index="rs-18" data-transition="zoomin" data-slotamount="7"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000"  data-thumb="images/it_service/slide7.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="slide3" data-description="">

              <img src="images/it_service/slide7.jpg"  alt=""  data-bgposition="center center" data-kenburns="on" data-duration="30000" data-ease="Linear.easeNone" data-scalestart="100" data-scaleend="120" data-rotatestart="0" data-rotateend="0" data-offsetstart="0 0" data-offsetend="0 0" data-bgparallax="10" class="rev-slidebg" data-no-retina>
    ...
    <div class="row">
      <div class="col-md-8">
        ...
        <div class="demo-gallery">
                  <ul id="lightgallery" class="list-unstyled row" style="text-align: center;">
                  <?PHP
                    ...
                    ?>
                      <li class="col-xs-6 col-sm-4 col-md-4" data-src="intranet/comunicados/<?PHP echo $colegiado['archivo']; ?>" >
                          <a href="">
                              <img class="img-responsive" src="intranet/comunicados/<?PHP echo $colegiado['archivo']; ?>" width="100%">
                          </a>
                      </li>
                      <?php } ?>                                    
                  </ul>
          ...
          <div class="demo-gallery">
                <ul id="lightgallery" class="list-unstyled row" style="text-align: center;">
                    <li class="col-xs-12 col-sm-12 col-md-12" data-src="intranet/comunicados/<?PHP echo $colegiado['archivo']; ?>" >
                        <a href="">
                            <img class="img-responsive" src="intranet/comunicados/<?PHP echo $colegiado['archivo']; ?>" width="100%">
                        </a>
                    </li>
      ...
      <div div class="col-md-4"><iframe src="https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2Fcehuanuco.org.pe&tabs=timeline&width=340&height=500&small_header=false&adapt_container_width=true&hide_cover=false&show_facepile=true&appId" width="100%" height="500" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowfullscreen="true" allow="autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share"></iframe></div>
    </div>
  </div>
</div> 
<!-- end section -->
        ...
        <div class="row">
          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 margin_bottom_50">
            ...
            <div class="text_align_right">
              <p class="counter-heading text_align_right">Colegiados</p>
            </div>
            <?PHP 
                include "conexion.php";
                $stmt = $bd->prepare("SELECT COUNT(*) FROM colegiado"); 
                $stmt->execute(); 
                foreach($stmt as $colegiado)
                {
            ?>
            <h5 class="counter-count"><?php echo $colegiado[0]; }?></h5>
          </div>
          
          <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 margin_bottom_50">
            <div class="text_align_right"><i class="fa fa-empire"></i></div>
            <div class="text_align_right">
              <p class="counter-heading">Universidades</p>
            </div>
            <?PHP 
                include "conexion.php";
                $stmt = $bd->prepare("SELECT COUNT(*) FROM universidad"); 
                $stmt->execute(); 
                foreach($stmt as $colegiado)
                {
            ?>
  ...
  <div class="container">
    <div class="row">
      <div class="col-md-12">
        <div class="full">
          <ul class="brand_list">
            <li><a target="_blank" href="https://enlinea.sunedu.gob.pe/"><img src="images/it_service/brand_icon8.png" alt="#" /></a></li>
            <li><a target="_blank" href="https://www.unheval.edu.pe/portal/"><img src="images/it_service/brand_icon9.png" alt="#" /></a></li>
            <li><a target="_blank" href="https://portal.unas.edu.pe/"><img src="images/it_service/brand_icon10.png" alt="#" /></a></li>
            <li><a target="_blank" href="https://www.mef.gob.pe/es/seguimiento-de-la-ejecucion-presupuestal-consulta-amigable"><img src="images/it_service/brand_icon11.png" alt="#" /></a></li>
            <li><a target="_blank" href="http://www.regionhuanuco.gob.pe/"><img src="images/it_service/brand_icon12.png" alt="#" /></a></li>
            <li><a target="_blank" href="https://www.munihuanuco.gob.pe/"><img src="images/it_service/brand_icon13.png" alt="#" /></a></li>
          </ul>
        </div>
      </div>
    </div>
    ...
    <div class="row">
      <div class="col-md-12">
        <center><a href="http://www.websmultimedia.com/contador-de-visitas-gratis" title="Contador De Visitas Gratis">
          <img style="border: 0px solid; display: inline;" alt="contador de visitas" src="http://www.websmultimedia.com/contador-de-visitas.php?id=288210"></a></center>
      </div>
    </div>
  </div>
</div>
  ...
  <div class="modal-dialog modal-login">
      <div class="modal-content">
          ...
          <div class="modal-body">
              <img src="images/it_service/aviso.jpg" width="100%" height="">
          </div>
      </div>
  </div>
</div>
...
<footer class="footer_style_2">
  <br><br>
  <div class="cprt">
    <p><b>CEH - Colegio de Economistas de Huánuco © Copyrights 2020 Design by Henjhorovi (THE WOLF)</b></p>
  </div>
</footer>
<!-- end footer -->
<!-- js section -->
