          ...
          <div class="box box-danger">
            ...
            <div class="box-body">
              ...
              <div class="input-group">
                  ...
                  <input type="text" class="form-control" data-mask="" value="<?php echo $colegiado['numero'] ?>" id="numero" name="numero" readonly="">
                    <input type="hidden" value="<?php echo $colegiado['id'] ?>" id="id" name="id">
                    <input type="hidden" value="23" id="op" name="op"
                <!-- /.input group -->
              </div>
              <div class="input-group">
                  <div class="input-group-addon">
                  ...
                  <input type="text" class="form-control" data-mask="" value="<?php echo $colegiado['nombre'] ?>" id="nombre" name="nombre" readonly="">
                <!-- /.input group -->
              </div>
              <div class="form-group">
                ...
                <div class="input-group">
                  <div class="input-group-addon">
                    ...
                    <input type="text" class="form-control"  value="<?php echo $colegiado['archivo'] ?>" id="archivo" name="archivo" readonly="">
                </div>
              </div>
              <div class="form-group">
                <label>PDF</label>
                <div class="input-group">
                  <div class="input-group-addon">
                    ...
                    <input type="text" class="form-control"  value="<?php echo $colegiado['file'] ?>" id="file" name="file" readonly="">
                </div>
              </div>
