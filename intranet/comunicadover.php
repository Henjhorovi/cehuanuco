              ...
              <div class="form-group">
                ...
                <div class="input-group">
                  <div class="input-group-addon">
                    ...
                    <input type="hidden" value="10" id="op" name="op">
                    <input type="hidden" value="<?php echo $colegiado['id'] ?>" id="iduni" name="idarc">
                    <input type="date" class="form-control" value="<?php echo $colegiado['fecha_inicio'] ?>" id="fecha_inicio" name="fecha_inicio"  >
                </div>
                <!-- /.input group -->
              </div>
              <div class="form-group">
                ...
                <div class="input-group">
                  <div class="input-group-addon">
                    ...
                    <input type="date" class="form-control" value="<?php echo $colegiado['fecha_fin'] ?>" id="fecha_fin" name="fecha_fin"  >
                </div>
              </div>
              <div class="form-group">
                <div class="input-group">
